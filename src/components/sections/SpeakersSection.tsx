                ...
                <div className='max-w-7xl mx-auto'>
                    ...
                    >
                        <div className='space-y-5 sm:space-y-6'>
                            ...
                            <p className='text-lg sm:text-xl text-gray-300 leading-relaxed'>
                                Meet the extraordinary individuals who will share their journeys of turning lessons into
                                legacies. Each speaker brings unique insights and inspiring stories from diverse fields.
                            </p>
                        </div>
                    </motion.div>
                    ...
                    {speakersAnnounced ? (
                        <motion.div
                            ...
                            className='speakers-content-grid grid lg:grid-cols-2 gap-12 items-center'
                        >
                                ...
                                <div className='orbital-container relative w-80 h-80 md:w-96 md:h-96'>
                                    ...
                                    <div className='orbiting-speakers-container absolute inset-0'>
                                        {orbitingSpeakers.map((speaker, index) => {
                                            const angle = index * (360 / orbitingSpeakers.length) * (Math.PI / 180);
                                            const radius = 140;
                                            ...
                                            return (
                                                <motion.button
                                                    key={speaker.id}
                                                    onClick={() => handleSpeakerClick(speakers.indexOf(speaker))}
                                ...
                                <AnimatePresence mode='wait'>
                                    ...
                                    >
                                        <div className='space-y-6'>
                                            ...
                                            <p className='text-gray-400 text-sm leading-relaxed'>{activeSpeaker.bio}</p>
