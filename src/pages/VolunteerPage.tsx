                ...
                <div className='container mx-auto px-4'>
                    ...
                    >
                        <h1 className='text-4xl md:text-6xl font-bold text-white mb-6'>
                            Join Our <span className='text-[var(--color-tedx-red)]'>Team</span>
                        </h1>
                    ...
                    >
                        <div className='text-center'>
                            <div className='w-16 h-16 bg-[var(--color-tedx-red)]/20 rounded-full flex items-center justify-center mx-auto mb-4'>
                                <Heart className='w-8 h-8 text-[var(--color-tedx-red)]' />
                            </div>
                        ...
                        <div className='text-center'>
                            <div className='w-16 h-16 bg-[var(--color-tedx-red)]/20 rounded-full flex items-center justify-center mx-auto mb-4'>
                                <Users className='w-8 h-8 text-[var(--color-tedx-red)]' />
                            </div>
                        ...
                        <div className='text-center'>
                            <div className='w-16 h-16 bg-[var(--color-tedx-red)]/20 rounded-full flex items-center justify-center mx-auto mb-4'>
                                <Award className='w-8 h-8 text-[var(--color-tedx-red)]' />
                            </div>
                                            ...
                                            <div className='flex items-start gap-4'>
                                                <div
                                                    className={`p-3 rounded-full ${
                                                        isSelected ? 'bg-[var(--color-tedx-red)]' : 'bg-gray-700'
                                                    }`}
                                                >
                                                ...
                                                <div className='flex-1'>
                                                    ...
                                                    <div className='space-y-3'>
                                                        <div>
                                                            <h4 className='text-sm font-semibold text-[var(--color-tedx-red)] mb-1'>
                                                                Requirements:
                                                            </h4>
                                        ...
                                        <div className='flex flex-wrap gap-2'>
                                            {selectedRoles.map(roleId => {
                                                ...
                                                return (
                                                    <span
                                                        key={roleId}
                                                        className='bg-[var(--color-tedx-red)] text-white px-3 py-1 rounded-full text-sm'
                                                    >
                                                        {role?.title}
                                                    </span>
                                                );
